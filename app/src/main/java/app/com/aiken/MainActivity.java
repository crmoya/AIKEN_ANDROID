...
public class MainActivity extends AppCompatActivity {
    ...
    private String getUsuario(){
        SharedPreferences prefe=getSharedPreferences("datos_aiken", Context.MODE_PRIVATE);
        return prefe.getString("usuario_aiken","");
    }
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                if(usuario.equals("")){
                    ...
                    Toast.makeText(getApplicationContext(), "POR FAVOR SINCRONICE CON EL CÓDIGO QR DE LA APLICACIÓN AIKEN.", Toast.LENGTH_SHORT).show();
                }
